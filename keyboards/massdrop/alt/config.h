...
/* Enable some of the reactive RGB features */
#define RGB_MATRIX_KEYPRESSES
#define RGB_MATRIX_LED_PROCESS_LIMIT 15
#define RGB_MATRIX_LED_FLUSH_LIMIT 10

/* disable some of the built in RGB effect */
...
// must have RGB_MATRIX_FRAMEBUGGER_EFFECTS defined
// #define DISABLE_RGB_MATRIX_TYPING_HEATMAP
// #define DISABLE_RGB_MATRIX_DIGITAL_RAIN

// must have RGB_MATRIX_KEYPRESSES || RGB_MATRIX_KEYRELEASES defined
#define DISABLE_RGB_MATRIX_SOLID_REACTIVE
#define DISABLE_RGB_MATRIX_SOLID_REACTIVE_SIMPLE
#define DISABLE_RGB_MATRIX_SOLID_REACTIVE_WIDE
// like the multiwide one, want to customise it so it has a solid BG
